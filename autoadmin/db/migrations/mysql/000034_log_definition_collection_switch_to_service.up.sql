...
-- 用 INSERT IGNORE 吸收 (service_id, log_definition_id) 唯一键冲突，等价于"已存在则跳过"。
INSERT IGNORE INTO assets_application_service_log_setting
...
SELECT NOW(6),NOW(6),NULL,FALSE,ld.id,NULL,s.id,NULL,NULL
