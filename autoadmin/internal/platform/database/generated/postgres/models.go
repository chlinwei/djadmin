...
type AssetsCloudaccount struct {
	ID         int64          `json:"id"`
	CreateTime time.Time      `json:"create_time"`
	UpdateTime time.Time      `json:"update_time"`
	Remark     sql.NullString `json:"remark"`
	...
	AccessKey  sql.NullString `json:"access_key"`
...
type AssetsWebsshTempCredential struct {
	ID           int64         `json:"id"`
	SessionPk    sql.NullInt32 `json:"session_pk"`
...
type AutomationControllerSshKey struct {
	ID         int64          `json:"id"`
	CreateTime time.Time      `json:"create_time"`
	UpdateTime time.Time      `json:"update_time"`
	Remark     sql.NullString `json:"remark"`
...
type AutomationExecutionHostLog struct {
	ID               int64           `json:"id"`
	Remark           sql.NullString  `json:"remark"`
	CreateTime       time.Time       `json:"create_time"`
	UpdateTime       time.Time       `json:"update_time"`
...
type SysUserGroupMember struct {
	ID         int64     `json:"id"`
	CreateTime time.Time `json:"create_time"`
	GroupID    int64     `json:"group_id"`
	UserID     int32     `json:"user_id"`
