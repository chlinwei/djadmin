...
type Querier interface {
	...
	ClaimBaselineScan(ctx context.Context, id int64) (int64, error)
	...
	DeleteBaselineItem(ctx context.Context, id int64) (int64, error)
	...
	MaxBaselineCategorySort(ctx context.Context, baselineID int64) (interface{}, error)
	...
	UpdateBaselineScanTarget(ctx context.Context, arg UpdateBaselineScanTargetParams) error
