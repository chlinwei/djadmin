...
router.register(r'projects', ProjectManage, basename="projects")
router.register(r'business-environments', BusinessEnvironmentManage, basename="business-environments")
