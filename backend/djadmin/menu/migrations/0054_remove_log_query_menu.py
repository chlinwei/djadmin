...
def restore_log_query_menu(apps, schema_editor):
    SysMenu = apps.get_model('menu', 'SysMenu')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('menu', '0053_add_log_query_menu'),
    ]

    operations = [
        migrations.RunPython(remove_log_query_menu, restore_log_query_menu),
    ]
