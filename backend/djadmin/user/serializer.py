...
class SysUserSerializer(ModelSerializer):
    class Meta:
        model = SysUser
        fields = ["id","username","avatar","phonenumber","login_date","status","create_time","update_time","remark","timezone"]
...
class SysUserRoleSerializer(ModelSerializer):
    ...
    class Meta:
        model = SysUser
        fields = ["id","username","avatar","phonenumber","login_date","status","create_time","update_time","roles","remark","timezone"]
...
class UserDetailCreateSerializer(ModelSerializer):
    class Meta:
        model = SysUser
        fields = ["id","username","phonenumber","status","remark","timezone"]
    # 创建用户
